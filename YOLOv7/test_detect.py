...
classes_to_filter = 'person'  #You can give list of classes to filter by name, Be happy you don't have to put class number. ['train','person' ]
source_image_path = "E:\CTU\LUAN_VAN_2023\sample_img_pose\pose_sit_wi_2_resize.jpg"

opt  = {
    "weights": "E:\CTU\LUAN_VAN_2023\YOLOv7\pretrain\yolov7.pt", # Path to weights file default weights are for nano model
    "yaml"   : "E:\CTU\LUAN_VAN_2023\YOLOv7\data\coco.yaml",
