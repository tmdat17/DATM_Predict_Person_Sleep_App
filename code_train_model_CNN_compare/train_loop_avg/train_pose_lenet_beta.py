...
while i <= AVG:
    ...
    # model.save("./model_lenet_train_pose/lenet_epo{}_bs{}_2500pics.h5".format(EPOCHS, BS))
    ...
    # plt.grid(True)
    # plt.savefig(f'./chart_loss_and_accuracy_lenet/epochs_{EPOCHS}_bs_{BS}_2500pics.png', dpi=300)
    # plt.show()
    ...
    # plt.ylabel('True')
    # plt.savefig(f'./confusion_matrix_lenet/epochs_{EPOCHS}_bs_{BS}_2500pics.png', dpi=300)
    # plt.show()
    ...
    # print('Time train Lenet: ', round(end_time/60,2))
...
print('Time train Lenet: ', average(timeTrainArr))
print('Time predict Lenet: ', average(timePredictArr))