# main train CNN (inceptionV3) POSE (stand, lie, sit)
import numpy as np 
...
while i <= AVG:
    ...
    print("bat dau fit model InceptionV3")
    ...
    # model.save("./model_inceptionV3_train_pose/inceptionV3_epo{}_bs{}_2500pics.h5".format(EPOCHS, BS))
    ...
    # plt.grid(True)
    # plt.savefig(f'./chart_loss_and_accuracy_inceptionV3/epochs_{EPOCHS}_bs_{BS}_2500pics.png', dpi=300)
    # plt.show()
    ...
    # plt.ylabel('True')
    # plt.savefig(f'./confusion_matrix_inceptionV3/epochs_{EPOCHS}_bs_{BS}_2500pics.png', dpi=300)
    # plt.show()
    ...
    # print('Time train inceptionV3: ', round(end_time/60,2))
...
print('Time train InceptionV3: ', average(timeTrainArr))
print('Time predict InceptionV3: ', average(timePredictArr))