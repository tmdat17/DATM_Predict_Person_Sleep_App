# LOOP
# main train CNN (MobileNet) POSE (stand, lie, sit)
import numpy as np 
...
while i <= AVG:
    ...
    print("bat dau fit model MobileNet")
    ...
    # model.save("./model_mobileNet_train_pose/mobileNet_epo{}_bs{}_2500pics.h5".format(EPOCHS, BS))
    ...
    # plt.grid(True)
    # plt.savefig(f'./chart_loss_and_accuracy_mobileNet/epochs_{EPOCHS}_bs_{BS}_2500pics.png', dpi=300)
    # plt.show()
    ...
    # plt.ylabel('True')
    # plt.savefig(f'./confusion_matrix_mobileNet/epochs_{EPOCHS}_bs_{BS}_2500pics.png', dpi=300)
    # plt.show()
    ...
    # print('Time train MobileNet: ', round(end_time/60,2))
...
print('Time train mobileNet: ', average(timeTrainArr))
print('Time predict mobileNet: ', average(timePredictArr))