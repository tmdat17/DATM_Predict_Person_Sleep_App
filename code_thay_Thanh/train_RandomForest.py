...
while (n < N_AVERAGE):
    ...
    Model_Sleep = RandomForestClassifier(n_estimators=N_ESTIMATORS, max_depth=MAX_DEPTH, random_state=0, criterion='entropy')
...
print (f"Danh gia mo hinh RandomForest {LIMIT_LINE} lines\nk = {K}\nN_AVERAGE = {N_AVERAGE}\nN_ESTIMATORS = {N_ESTIMATORS}\nMAX_DEPTH = {MAX_DEPTH}")
